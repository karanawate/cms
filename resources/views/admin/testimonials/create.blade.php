...
@section('content')
    <div class="m-3 bg-white rounded-xl border p-4 shadow-sm">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="description" id="first_name" autocomplete="given-name" class="rounded-lg px-3 mt-1 w-full py-1 transition duration-300 border border-gray-300 rounded focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-400">
        </div>
        <div>
              <label class="block text-sm font-medium text-gray-700">
                Cover photo
              </label>
              <div class="mt-2 flex justify-center px-6 pt-5 pb-6 text-white border-2 border-gray-300 border-dashed rounded-md">
